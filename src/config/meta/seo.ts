...
export const defaultSEO = {
  title: 'Égida Jurídica - Servicios Legales',
  description:
    'Égida Jurídica es un bufete de abogados especializado en múltiples áreas del derecho',
  keywords: 'abogados, derecho civil, derecho penal, derecho laboral, asesoría legal',
  type: 'website',
  author: 'Égida Jurídica',
  robots: 'index, follow',
}

export const siteConfig = {
  name: 'Égida Jurídica',
  baseUrl: 'https://egidajuridica.com',
  themeColor: '#1f2937',
  locale: 'es-MX',
